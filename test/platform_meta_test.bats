...
@test "somerville in focal : Error if meta package in remove candidate state" {
    set -e
    ubuntu_codename='focal'
    BIOSID='08AF'
    ubuntu_drivers_string="oem-somerville-beric-icl-meta"
...
@test "somerville in focal : Error if meta package Not installed" {
    set -e
    ubuntu_codename='focal'
    BIOSID='08AF'
    ubuntu_driers_string="oem-somerville-beric-icl-meta"
    function dpkg() {
        echo "$dpkg_string"
    }
    function apt-cache() {
...
@test "somerville in focal : Error if factory meta package Not installed" {
    set -e
    ubuntu_codename='focal'
    BIOSID='08AF'
    ubuntu_driers_string="oem-somerville-beric-icl-meta"
